      ...
      <Form {...form}>
        ...
        >
          ...
          <Section
            title="Attributes"
            collapsable
            contentCn="flex justify-evenly"
          >
            <Section title="Physical" shrink contentCn="space-y-2">
              <RatingField
                label="Strength"
                name="attributes.physical.strength"
              />
              <RatingField
                label="Dexterity"
            ...
            <Section title="Mental" shrink contentCn="space-y-2">
              ...
              <RatingField
                label="Reasoning"
                name="attributes.mental.reasoning"
              />
              <RatingField
                label="Perception"
          ...
          <Section title="Skills" collapsable contentCn="flex justify-evenly">
            <Section title="Talents" shrink contentCn="space-y-2">
              ...
              <RatingField
                label="Expression"
                name="skills.talents.expression"
              />
              <RatingField
                label="Intimidation"
              ...
              <RatingField
                label="Leadership"
                name="skills.talents.leadership"
              />
              <RatingField label="Cunning" name="skills.talents.cunning" />
              <RatingField
                label="Smooth Talk"
                name="skills.talents.smoothTalk"
              />
              <RatingField
            ...
            <Section title="Expertise" shrink contentCn="space-y-2">
              <RatingField
                label="Etiquette"
                name="skills.expertise.etiquette"
              />
              <RatingField
                label="Performance"
              ...
              <RatingField
                label="Deception"
                name="skills.expertise.deception"
              />
              <RatingField
                label="Interrogation"
            ...
            <Section title="Knowledge" shrink contentCn="space-y-2">
              ...
              <RatingField
                label="Occultism"
                name="skills.knowledge.occultism"
              />
              <RatingField
                label="Cryptozoology"
